...
for i in {1..5}; do
	echo "ini file documen ke-$i" > documen$i.doc   # Membuat file .doc dengan isi teks
	echo "ini file arsip ke-$i" > arsip$i.zip       # Membuat file .zip dengan isi teks
	touch gambar$i.png                              # Membuat file kosong .png
	touch filelogs$i.log                            # Membuat file kosong .log
done
